...
import { 
  Search, ShoppingBag, Eye, Check, ChevronRight, 
  Ruler, ShieldCheck, Globe, Droplets, Sparkles, 
  Package, Info, ArrowRight, X, Heart, Leaf, Recycle, 
  BadgeCheck, Armchair, Sofa, Compass, MessageCircle, 
  Copy, ExternalLink, HelpCircle, Wrench, CheckCircle2
} from 'lucide-react';
        ...
        <div className="bg-[#1A261E] text-stone-100 rounded-3xl p-8 sm:p-10 relative overflow-hidden shadow-xl border border-stone-800">
          <div className="max-w-2xl space-y-3 relative z-10">
            ...
            <p className="text-stone-300 text-xs sm:text-sm leading-relaxed">
              รวบรวมวัสดุส่วนเกิน (Surplus & Archive) จากโรงงานทอ สตูดิโอไทย และยุโรป คัดสรรด้วยมาตรฐานช่าง Chaw Cher เปิดโอกาสให้ Designer และลูกค้าทั่วไปเลือกตัดแบ่งเป็นเมตร หรือสั่งผลิตเฟอร์นิเจอร์ยั่งยืน
            </p>
          </div>
        </div>
      </div>
